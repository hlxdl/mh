...
("undefined"!=typeof window?window:this,function(a,b){
	...
	n.extend=n.fn.extend=function(){
		...
		i>h;h++)if(null!=(a=arguments[h]))for(b in a)c=g[b],
		d=a[b],
	...
	var t=function(a){
		...
		X={
			ID:new RegExp("^#("+N+")"),
			CLASS:new RegExp("^\\.("+N+")"),
			TAG:new RegExp("^("+N.replace("w","w*")+")"),A,
			TTR:new RegExp("^"+P),
			PSEUDO:new RegExp("^"+Q),
			CHILD:new RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\("+M+"*(even|odd|(([+-]|)(\\d*)n|)"+M+"*(?:([+-]|)"+M+"*(\\d+)|))"+M+"*\\)|)","i"),
			bool:new RegExp("^(?:"+L+")$","i"),needsContext:new RegExp("^"+M+"*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\("+M+"*((?:-\\d)?\\d*)"+M+"*\\)|)(?=[^-]|$)","i")
		},
		...
		function fb(a,b,d,e){
			...
			if(p&&!e){
				...
				}else{if(f[2])return I.apply(d,b.getElementsByTagName(a)),
				d;
		...
		m=fb.setDocument=function(a){
			...
			g=e.defaultView;
			return e!==n&&9===e.nodeType&&e.documentElement?(n=e,o=e.documentElement,p=!f(e),
